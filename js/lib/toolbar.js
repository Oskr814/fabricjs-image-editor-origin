        ...
        $(`${this.containerSelector} #toolbar .extended-buttons button`).click(
          function () {
            ...
            if (id === 'save') {
              ...
              if (
                window.confirm(
                  'Esta acción revertira todos los cambios realizados, esta seguro que desea continuar?'
                )
              ) {
                  ...
                  fabric.Image.fromURL(
                    ...
                    function (background) {
                      _self.canvas.setBackgroundImage(
                        ...
                        {
                          scaleX: _self.canvas.width / background.width,
                          scaleY: _self.canvas.height / background.height,
                        }
                      );
                    }
                  );
                } catch (error) {
                  alert('Error al cargar la marca de agua.');
                }
              }
            } else if (id === 'download') {
