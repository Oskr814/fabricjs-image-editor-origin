...
(function () {
  ...
  var selectionSettings = function () {
    const _self = this;
    $(`${this.containerSelector} .main-panel`).append(`<div class="toolpanel" id="select-panel"><div class="content"><p class="title">Elemento seleccionado</p></div></div>`);

    // font section
    (() => {
      $(`${this.containerSelector} .toolpanel#select-panel .content`).append(`
        <div class="text-section">
          <h4>Estilo tipografía</h4>
          <div class="style">
          ...
          <div class="sizes">
            <div class="input-container"><label>Tamaño</label>
            ...
            <div class="input-container"><label>Altura linea</label>
              <div class="custom-number-input">
              <button class="decrease">-</button>
            ...
            <div class="input-container"><label>Espaciado letra</label>
              <div class="custom-number-input">
              <button class="decrease">-</button>
    ...
    (() => {
      $(`${this.containerSelector} .toolpanel#select-panel .content`).append(`
        <div class="border-section">
          ...
          <div class="input-container"><label>Tipo de esquina</label><select id="input-corner-type"><option value="miter" selected>Square</option><option value="round">Round</option></select></div>
